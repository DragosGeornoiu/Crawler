...
import ro.project.comparator.Application;
...
public class WebCrawlerProject {
	...
	public static void main(String[] args) throws IOException {
		...
		app.checkHtmlOfUrl("http://localhost:8080/SpringTest2/login");		
	}
}
	/*
	 ...
	 * img = doc.select("img"); for(Element i : img)
	 ...
	 * Jsoup.connect("http://localhost:8080/SpringTest2/login").get(); Elements
	 * b = doc.select("b"); for(Element bold : b)
	 ...
	 * Jsoup.connect("http://localhost:8080/SpringTest2/login").get(); Elements
	 * h1 = doc.select("h1"); for(Element h : h1) System.out.println(h.text());
	 * }
	 * 
	 * public static void getH2() throws IOException { Document doc =
	 * Jsoup.connect("http://localhost:8080/SpringTest2/login").get(); Elements
	 * h2 = doc.select("h2"); for(Element h : h2) System.out.println(h.text());
	 * }
	 * 
	 * public static void getH3() throws IOException { Document doc =
	 * Jsoup.connect("http://localhost:8080/SpringTest2/login").get(); Elements
	 * h3 = doc.select("h3"); for(Element h : h3) System.out.println(h.text());
	 * }
	 * 
	 ...
	 * e.attr("charset")); } else { System.out.println("name: " + name
	 ...
	 * 
	 * public static void getHtml() throws IOException { Connection.Response
	 * html =
